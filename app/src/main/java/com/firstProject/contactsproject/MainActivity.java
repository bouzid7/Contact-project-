...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextInputEditText birthdate_acc;
    Button singin;
    Button signup_auth;
    Button signup_acc;
    Button cancel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        birthdate_acc= (TextInputEditText) findViewById(R.id.birthdate_acc);
    ...
    private  void InsertInCloudDatabase(){
        ...
        String birthdate =  birthdate_acc.getText().toString();
